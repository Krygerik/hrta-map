...
-- —оотношение расы на регион родной земли с большими преп€тстви€ми
...
function blockFriendlyBattlefield()
  ...
  -- Ѕлокируем родные пол€ны с маленькими преп€тстви€ми
  for _, playerId in PLAYER_ID_TABLE do
    local playerRaceId = RESULT_HERO_LIST[playerId].raceId;

    -- “.к. через их пол€ надо проходить, блокировать их низ€ :(
  ...
  -- ѕридурку-Ќибросу разрешаем посещать его родную пол€ну
  ...
  -- ѕри отсутствии "Ќахождени€ пути" или наличии его у обоих игроков, выбрать пол€ну с большими преп€тстви€ми невозможно
  if (
  ...
  -- ≈сли у игрока есть "Ќахождение пути", блочим родные земельки с большими преп€тстви€ми
  -- “акже разрешаем выбрать родные земли с маленькими преп€тстви€ми
