...
function vaishanSpec(heroName)
  ...
  if GetHeroCreatures(heroName, CREATURE_SCOUT) >= GetHeroCreatures(heroName, CREATURE_ASSASSIN) then
    AddHeroCreatures(heroName, CREATURE_SCOUT, floor(heroLevel * VAISHAN_BONUS_BY_LEVEL));
  else
    AddHeroCreatures(heroName, CREATURE_ASSASSIN, floor(heroLevel * VAISHAN_BONUS_BY_LEVEL));
  end;
end;
...
function runHeroSpecialization(playerId)
  ...
  -- Вайшан
--  if dictHeroName == HEROES.OHTARIG then
--    vaishanSpec(mainHeroName);
--  end;
  
--  if dictHeroName == HEROES.VAISHAN then
--    vaishanSpec(mainHeroName);
--  end;
