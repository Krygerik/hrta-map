...
function moveDelimetersToRandomChoise()
  ...
  SetObjectPosition('red12', 44, 24);
  SetObjectPosition('red13', 45, 24);
  SetObjectPosition('red14', 46, 24);
  SetObjectPosition('red15', 44, 22);
  SetObjectPosition('red18', 44, 20);
  SetObjectPosition('red19', 45, 20);
  SetObjectPosition('red20', 46, 20);
  SetObjectPosition('blue1', 37, 89);
  SetObjectPosition('blue2', 38, 89);
  SetObjectPosition('blue3', 39, 89);
  SetObjectPosition('blue4', 37, 87);
  SetObjectPosition('blue7', 37, 85);
  SetObjectPosition('blue8', 38, 85);
  SetObjectPosition('blue9', 39, 85);
  SetObjectPosition('red4', 33, 88)
  SetObjectPosition('red5', 33, 86)
  SetObjectPosition('red16', 44, 23)
  SetObjectPosition('red17', 44, 21)
  
  SetObjectPosition('blue5', 37, 86)
  SetObjectPosition('blue6', 37, 88)
